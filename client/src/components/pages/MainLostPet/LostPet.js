...
class LostPet extends Component {
  render() {
    ...
    let region = "서울";
    if (petinfo.pet_lost_region % 18 === 2) {
      region = "부산";
    }
    if (petinfo.pet_lost_region % 18 === 3) {
      region = "대구";
    }
    if (petinfo.pet_lost_region % 18 === 4) {
      region = "인천";
    }
    if (petinfo.pet_lost_region % 18 === 5) {
      region = "광주";
    }
    if (petinfo.pet_lost_region % 18 === 6) {
      region = "대전";
    }
    if (petinfo.pet_lost_region % 18 === 7) {
      region = "울산";
    }
    if (petinfo.pet_lost_region % 18 === 8) {
      region = "세종";
    }
    if (petinfo.pet_lost_region % 18 === 9) {
      region = "경기";
    }
    if (petinfo.pet_lost_region % 18 === 10) {
      region = "강원";
    }
    if (petinfo.pet_lost_region % 18 === 11) {
      region = "충북";
    }
    if (petinfo.pet_lost_region % 18 === 12) {
      region = "충남";
    }
    if (petinfo.pet_lost_region % 18 === 13) {
      region = "전북";
    }
    if (petinfo.pet_lost_region % 18 === 14) {
      region = "전남";
    }
    if (petinfo.pet_lost_region % 18 === 15) {
      region = "경북";
    }
    if (petinfo.pet_lost_region % 18 === 16) {
      region = "경남";
    }
    if (petinfo.pet_lost_region % 18 === 17) {
      region = "제주";
    }
